...
export const metadata: Metadata = {
  title: "Eggthropic — Laboratorio de Claude",import type { Metadata } from "next";
import Link from "next/link";
import { ArrowRight } from "lucide-react";
import { Hero } from "@/components/Hero";
import { SectionHeader } from "@/components/SectionHeader";
...
export default function HomePage() {
  ...
  const boardPreview = toBoardExperiments(experiments).slice(-6).reverse();
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-end justify-between mb-10">
            <SectionHeader
              ...
              description="Los mismos experimentos, en formato tablón: categoría, dificultad, progreso y última ejecución."
              className="mb-0"
            />
            <Link
              href="/experiments?view=board"
          ...
          <LabStatusBoard experiments={boardPreview} compact />
          ...
          <div className="mt-6 sm:hidden">
            ...
            >
              Tablón completo <ArrowRight className="w-3.5 h-3.5" />
            </Link>
          </div>
        </div>
      </section>
