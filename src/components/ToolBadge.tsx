...
const toolColors: Record<string, string> = {
  "Claude Design": "bg-rose-500/10 text-rose-600 border-rose-500/20",
  "Claude Opus 4.7": "bg-orange-500/10 text-orange-300 border-orange-500/20",
  "Claude Code": "bg-violet-500/10 text-violet-700 border-violet-500/20",
  "Agent Skills": "bg-fuchsia-500/10 text-fuchsia-700 border-fuchsia-500/20",
  MCP: "bg-cyan-500/10 text-cyan-700 border-cyan-500/20",
  "Claude API": "bg-indigo-500/10 text-indigo-300 border-indigo-500/20",
  "Next.js": "bg-slate-500/10 text-ink-soft border-slate-500/20",
